...
let RoomController = class RoomController {
    ...
    async createRoom(type, user, body) {
        await this.roomService.createRoom(type, user, body);
    }
    findjoinRoom(user) {
        this.roomService.findjoinRoom(user, param);
    }
    async joinRoom(user, body) {
        await this.roomService.joinRoom(2, body.existingRoomMembersLength || 0, user.id);
    }
    findAllRoom(user) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof user_entity_1.Users !== "undefined" && user_entity_1.Users) === "function" ? _f : Object, Object]),
    __metadata("design:returntype", Promise)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("aeff301c4ce417e6df1c")
/******/ })();
/******/ 
/******/ }
;