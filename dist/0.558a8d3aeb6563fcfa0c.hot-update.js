...
let VarificationsService = class VarificationsService {
    ...
    async requestMail(type, body) {
        ...
        await this.mailerService
            ...
            template: type.hasOwnProperty(varifications_entity_1.VerificationTypeEnum.MAIL)
                ? "index"
                : type.hasOwnProperty(varifications_entity_1.VerificationTypeEnum.PASSWORD)
                    ? "index"
                    : "findSignname",
            context: type.hasOwnProperty(varifications_entity_1.VerificationTypeEnum.MAIL)
        ...
        console.log(type);
        console.log(varifications_entity_1.VerificationTypeEnum.MAIL);
        const args = {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("447af7ead3c74b198344")
/******/ })();
/******/ 
/******/ }
;