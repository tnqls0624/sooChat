...
let VarificationsRepository = class VarificationsRepository {
    ...
    async requestMail(args) {
        ...
        try {
            ...
            await queryRunner.manager.upsert(varifications_entity_1.Varification, [{ type: args.type, token: args.token, key: args.key }], ["id", "to", "type", "signname"]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("10bb7163c32956752cff")
/******/ })();
/******/ 
/******/ }
;