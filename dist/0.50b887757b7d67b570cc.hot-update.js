...
let VarificationsRepository = class VarificationsRepository {
    ...
    async requestMail(args) {
        ...
        try {
            ...
            await queryRunner.manager.findOne(varifications_entity_1.Varification, {
                where: { type: args.type, to: args.to, signname: args.signname },
            });
            await queryRunner.manager.upsert(varifications_entity_1.Varification, [args], ["id"]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d7cfefa2a21b5a731905")
/******/ })();
/******/ 
/******/ }
;