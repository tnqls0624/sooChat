...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => chat_entity_1.Chat, (chat) => chat.signname),
...
__decorate([
    ...
    (0, class_transformer_1.Transform)((params) => params.value.trim()),
    (0, class_validator_1.IsString)(),
    (0, typeorm_1.Column)({ type: "varchar", comment: "프로필 배경화면" }),
    __metadata("design:type", String)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("687c8f10498ee1db9438")
/******/ })();
/******/ 
/******/ }
;