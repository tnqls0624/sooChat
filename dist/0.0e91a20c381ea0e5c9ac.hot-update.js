...
const events_module_1 = __webpack_require__(69);
const events_gateway_1 = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module './events.gateway'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [app_service_1.AppService, logger_middleware_1.LoggerMiddleware, common_1.Logger, events_gateway_1.EventsGateway],
    })
], AppModule);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4e848537ec26e448a85a")
/******/ })();
/******/ 
/******/ }
;