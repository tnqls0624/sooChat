...
let FriendController = class FriendController {
    ...
    async joinRoom(user, id, body) {
        await this.friendService.inviteFriend(id, user.id);
    }
};
__decorate([
...
__decorate([
    ...
    (0, common_1.Post)("/invite/:user_id"),
    __param(0, (0, user_decorator_1.User)()),
    __param(1, (0, common_1.Param)("user_id")),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof user_entity_1.Users !== "undefined" && user_entity_1.Users) === "function" ? _d : Object, Number, typeof (_e = typeof inviteFriend_dto_1.InviteFriend !== "undefined" && inviteFriend_dto_1.InviteFriend) === "function" ? _e : Object]),
    __metadata("design:returntype", Promise)
...
class InviteFriend extends (0, swagger_1.PickType)(friend_eneity_1.Friend, ["friend_id"]) {
}
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1879f0bd9d4692f5066c")
/******/ })();
/******/ 
/******/ }
;