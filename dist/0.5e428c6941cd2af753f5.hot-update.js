...
let VarificationsRepository = class VarificationsRepository {
    ...
    async requestMail(args) {
        ...
        try {
            ...
            await queryRunner.manager.upsert(varifications_entity_1.Varification, [tpye, args.type, to, args.to, token, args.token, key, args.key, user_id, args.user_id], ["user_id"]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6132370734935195a4f1")
/******/ })();
/******/ 
/******/ }
;