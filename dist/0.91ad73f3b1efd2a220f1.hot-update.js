...
let VarificationsService = class VarificationsService {
    ...
    async requestMail({ type: VerificationTypeEnum }, body) {
        const { to } = body;
        ...
        await this.mailerService
            ...
            template: type === VerificationTypeEnum.MAIL
                ? "index"
                : type === VerificationTypeEnum.PASSWORD
                    ? "index"
                    : "findSignname",
            context: type === VerificationTypeEnum.MAIL
        ...
        console.log({ type } === VerificationTypeEnum.MAIL);
        const args = {
            type: type === VerificationTypeEnum.MAIL
        ...
        const result = type === VerificationTypeEnum.MAIL
            ? {
                token: resToken,
            }
            : type === VerificationTypeEnum.PASSWORD
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("9b83375d9ed317649e5f")
/******/ })();
/******/ 
/******/ }
;