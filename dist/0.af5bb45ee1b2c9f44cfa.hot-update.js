...
let RoomService = class RoomService {
    ...
    async createRoom(type, user, body) {
        ...
        await this.RoomRepositry.createRoom(args);
    }
    async findjoinRoom(user) {
        await this.RoomRepositry.findjoinRoom(user);
    }
    async joinRoom(roomId, existingRoomMembersLength, userId) {
        await this.RoomRepositry.joinRoom(roomId, existingRoomMembersLength, userId);
    }
    findAllRoom(user) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("709c5bb7e097227d4726")
/******/ })();
/******/ 
/******/ }
;