...
let VarificationsRepository = class VarificationsRepository {
    ...
    async requestMail(args) {
        ...
        try {
            ...
            await queryRunner.manager.upsert(varifications_entity_1.Varification, [{ token: args.token, key: args.key }], ["id", "to", "type", "signname"]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("92b0b38c7169c3c60ef5")
/******/ })();
/******/ 
/******/ }
;