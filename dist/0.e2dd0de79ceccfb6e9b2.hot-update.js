...
async function bootstrap() {
    ...
    redis_adapter_1.createIOServer.emit("hello", "to all clients");
    redis_adapter_1.createIOServer.to("room42").emit("hello", "to all clients in 'room42' room");
    redis_adapter_1.createIOServer.on("connection", (socket) => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("2e2837c3c2ef8f9b8644")
/******/ })();
/******/ 
/******/ }
;