...
let ChatGateway = ChatGateway_1 = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        this.server.emit("msgToClient", {
            name: (_b = (_a = client === null || client === void 0 ? void 0 : client.handshake) === null || _a === void 0 ? void 0 : _a.query) === null || _b === void 0 ? void 0 : _b.name,
            text: `join chat.`,
        });
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7e36afc884b5ddf23ee2")
/******/ })();
/******/ 
/******/ }
;