...
let RoomService = class RoomService {
    ...
    createRoom(type, user, body) {
        const args = Object.assign(Object.assign({ type }, body), { room_master_id: user.signname });
        this.RoomRepositry.createRoom(type, user, args);
    }
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("73b9af32f75eadcb3797")
/******/ })();
/******/ 
/******/ }
;