...
AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [
            ...
            (0, common_1.forwardRef)(() => varifications_entity_1.Varification),
        ],
        providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, auth_repository_1.AuthRepository, user_repository_1.UserRepository, common_1.Logger],
    })
], AuthModule);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("16b93c9893c4b4f9a9d8")
/******/ })();
/******/ 
/******/ }
;