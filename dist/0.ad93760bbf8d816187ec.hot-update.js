...
const participant_module_1 = __webpack_require__(80);
const chat_entity_1 = __webpack_require__(83);
const participant_entity_1 = __webpack_require__(84);
        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: async (config) => ({
                    ...
                    entities: [user_entity_1.Users, auth_entity_1.Auth, varifications_entity_1.Varification, room_entity_1.Room, chat_entity_1.Chat, participant_entity_1.Participant],
                    synchronize: true,
...
__decorate([
    ...
    (0, typeorm_1.Column)({ type: "varchar", length: 20, comment: "방이름" }),
    __metadata("design:type", String)
], Participant.prototype, "roomName", void 0);
__decorate([
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, typeorm_1.Column)({ type: "int", comment: "읽지않은 채팅 수" }),
    __metadata("design:type", Number)
], Participant.prototype, "notReadChat", void 0);
__decorate([
    (0, typeorm_1.CreateDateColumn)({ name: "create_at", comment: "생성일" }),
    __metadata("design:type", typeof (_a = typeof Date !== "undefined" && Date) === "function" ? _a : Object)
], Participant.prototype, "created_at", void 0);
__decorate([
    (0, typeorm_1.UpdateDateColumn)({ name: "update_at", comment: "수정일" }),
    __metadata("design:type", typeof (_b = typeof Date !== "undefined" && Date) === "function" ? _b : Object)
], Participant.prototype, "updated_at", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
...
], Participant.prototype, "signname", void 0);
__decorate([
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, typeorm_1.ManyToOne)(() => room_entity_1.Room, (room) => room.id),
    (0, typeorm_1.Column)({ type: "int", comment: "방 아이디" }),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ab2f06df5ee300fee5f7")
/******/ })();
/******/ 
/******/ }
;